...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/monster-strike/context` | Codebase overview, check index freshness |
| `gitnexus://repo/monster-strike/clusters` | All functional areas |
| `gitnexus://repo/monster-strike/processes` | All execution flows |
| `gitnexus://repo/monster-strike/process/{name}` | Step-by-step execution trace |
